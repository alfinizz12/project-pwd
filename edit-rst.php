<?php
    ...
    if($row->total >= 450000 and $row->total <= 650000){
        if($row->total == 450000){
            $extrabed = " ";
            $extrapillow = " ";
    ...
    } else if ($row->total >= 775000 and $row->total <= 975000){
        if($row->total == 775000){
            $extrabed = " ";
            $extrapillow = " ";
    ...
    } else if ($row->total >= 1050000 and $row->total <= 1250000){
        ...
        <div class="card-body">
            ...
            <form class="resort-booking" action="" method="post">
                <input type="hidden" name="id" value="<?=$row->id?>">
                    ...
                    <input class="input-booking fullname-input" type="text" placeholder="Insert Your Full Name" name="name" id="name" value="<?=$row->name?>" required>
                    <div class="row"><br>
                        <div class="col-6">
